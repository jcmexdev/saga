...
func main() {
	...
	// 1. Obtener direcciones de las variables de entorno (Clave para Docker)
	...
	// 3. Crear los clientes gRPC generados por Proto
	...
	// 4. Inyectar estos clientes en tu servicio de aplicación
	// Tu 'orderService' ahora recibirá todos los clientes para poder armar la Saga
...
// Funciones auxiliares para limpiar el main
